...
public abstract class ConfigurationBuilder<T>
{
    ...
    private IExcelCellAddress StartingAddress { get; set; } = new DefaultCellAddress(1, 1);
    ...
    /// </code>
    /// </example>
    public ConfigurationBuilder<T> AddHeaderStyle(Action<IExcelStyle> style)
    {
    ...
    public abstract ConfigurationBuilder<T> AddNamedStyle(string name, Action<IExcelStyle> style);

    /// <summary>
    /// Configure the TopLeft starting cell of the report
    /// </summary>
    /// <param name="address">Address of the top-left cell</param>
    public abstract ConfigurationBuilder<T> SetStartingAddress(string address);
    ...
    public abstract ConfigurationBuilder<T> SetStartingAddres(int row, int column);
    ...
    /// <summary>
    /// Default implementation of IExcelCellAddress
    /// </summary>
    private class DefaultCellAddress : IExcelCellAddress
    {
        public DefaultCellAddress(int row, int column)
        {
            Row = row;
            Column = column;
        }
    ...
    /// <summary>
    /// Protected method to allow derived classes to set the starting address
    /// </summary>
    /// <param name="address"></param>
    protected void SetStartingAddressInternal(IExcelCellAddress address)
    {
