...
public class ColumnInfo
{
    ...
    internal virtual void FormatHeader(IExcelRange cell, int height)
    {
        cell.Offset(0, 0, height, Width).Merge = true;
    }

    internal virtual void WriteCell(IExcelRange cell, Dictionary<string, PropertyInfo> properties, object? obj)
    {
        if (obj != null)
            cell.Value = properties[Name].GetValue(obj);
    }

    internal virtual void WriteHeader(IExcelRange cell)
    {
